export default function TopImpactedTable({ rows }: { rows:{ ticker:string; name:string; impact:number; reason:string }[] }) {
  return (
      ...
      <table className="min-w-full text-sm">
        <thead className="border-b border-zinc-200 dark:border-zinc-800">
          <tr className="text-zinc-600 dark:text-zinc-300">
            ...
            <th className="px-3 py-2 text-left text-xs font-medium">Cause</th>
          </tr>
        </thead>
